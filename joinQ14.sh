...
for i in 1; do
        ...
        for p_key in DICT; do
                for l_key in DICT; do
                        ...
                        java -Xmx4g -cp target/enc-selector-0.0.1-SNAPSHOT.jar:target/enc-selector-0.0.1-SNAPSHOT-jar-with-dependencies.jar edu.uchicago.cs.encsel.query.HashJoinTool
                        #cd $BASEDIR
                done
        done
done
