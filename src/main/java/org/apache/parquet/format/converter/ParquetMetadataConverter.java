...
//      columnChunk.meta_data.key_value_metadata = ; // nothing yet
  ...
  static org.apache.parquet.column.statistics.Statistics fromParquetStatisticsInternal(String createdBy, Statistics statistics, PrimitiveTypeName type, ParquetMetadataConverter.SortOrder typeSortOrder) {
  ...
  // disable complex logics
  // Visible for testing
  static org.apache.parquet.column.statistics.Statistics fromParquetStatisticsInternal
      (String createdBy, Statistics statistics, PrimitiveTypeName type, SortOrder typeSortOrder, int no) {
